...
const Home = () => {
  return (
    <section className="text-center py-20 px-4">
      ...
      <a
        href="https://discord.com/invite/tu-enlace"
        target="_blank"
      ...
      >
        Únete a la Comunidad
          ...
          <iframe src="https://discord.com/widget?id=762312334642642984&theme=dark" width="350" height="500" allowtransparency="true" frameborder="0" sandbox="allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts"></iframe>
    </section>
  );
};
