...
const Comunidad = () => {
  const serverIP = 'casapmo.ddns.net:25565'; 
  ...
  return (
    <section className="py-20 px-4 max-w-5xl mx-auto text-center">
      <h2 className="text-3xl md:text-4xl font-bold mb-6 text-purple-400">Servidor de minecraft</h2>
      <p className="text-lg mb-12">
        RandomCord es más que una web: es una comunidad activa en Discord para cualquier persona que busque pasar un buen rato.
      </p>
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-16">
        <div className="bg-gray-800 p-6 rounded-lg">
          ...
          <span className="font-mono text-purple-300">{serverIP}</span>
